...
export default class ReceiveVideoController {
    ...
    constructor(conference) {
        ...
        this._lastN = (_a = config === null || config === void 0 ? void 0 : config.startLastN) !== null && _a !== void 0 ? _a : ((config === null || config === void 0 ? void 0 : config.channelLastN) || LAST_N_UNLIMITED);
    ...
    _updateIndividualConstraints(maxFrameHeight) {
        ...
        if (individualConstraints && Object.keys(individualConstraints).length) {
            for (const value of Object.values(individualConstraints)) {
                value.maxHeight = maxFrameHeight !== null && maxFrameHeight !== void 0 ? maxFrameHeight : Math.min(value.maxHeight, this._maxFrameHeight);
            }
        }
        else {
