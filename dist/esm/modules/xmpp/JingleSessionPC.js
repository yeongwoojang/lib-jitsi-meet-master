...
export default class JingleSessionPC extends JingleSession {
    ...
    doInitialize(options) {
        ...
        pcOptions.usesCodecSelectionAPI = this.usesCodecSelectionAPI
            = browser.supportsCodecSelectionAPI() && ((_a = options.testing) === null || _a === void 0 ? void 0 : _a.enableCodecSelectionAPI) && !this.isP2P;
        ...
        if (!this.isP2P) {
            ...
            pcOptions.capScreenshareBitrate = !(((_b = options.desktopSharingFrameRate) === null || _b === void 0 ? void 0 : _b.max) > SS_DEFAULT_FRAME_RATE);
        }
