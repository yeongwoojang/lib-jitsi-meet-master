    ...
    this.currentStatsReport.forEach(now => {
        ...
        if (now.type === 'candidate-pair' && now.nominated && now.state === 'succeeded') {
            ...
            if (codec) {
                ...
                if (now.type === 'outbound-rtp'
                    && now.active
                    && (track === null || track === void 0 ? void 0 : track.isVideoTrack())
                    && (before === null || before === void 0 ? void 0 : before.totalEncodeTime)
                    && (before === null || before === void 0 ? void 0 : before.framesEncoded)
                    && now.frameHeight
                    && now.frameWidth) {
