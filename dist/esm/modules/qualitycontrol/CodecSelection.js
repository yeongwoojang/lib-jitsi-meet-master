...
export class CodecSelection {
    ...
    selectPreferredCodec(mediaSession) {
        ...
        const remoteCodecsPerParticipant = remoteParticipants === null || remoteParticipants === void 0 ? void 0 : remoteParticipants.map(remote => {
            ...
            if (peerMediaInfo === null || peerMediaInfo === void 0 ? void 0 : peerMediaInfo.codecList) {
                return peerMediaInfo.codecList;
            }
            else if (peerMediaInfo === null || peerMediaInfo === void 0 ? void 0 : peerMediaInfo.codecType) {
        ...
        session.setVideoCodecs(selectedCodecOrder, (_a = this.screenshareCodec) === null || _a === void 0 ? void 0 : _a.jvb);
    }
    /**
