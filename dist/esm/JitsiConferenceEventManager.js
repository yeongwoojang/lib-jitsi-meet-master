...
JitsiConferenceEventManager.prototype.setupChatRoomListeners = function () {
    ...
    (jid, txt, myJid, ts, nick, isGuest, messageId) => {
        ...
        conference.eventEmitter.emit(JitsiConferenceEvents.MESSAGE_RECEIVED, participantId, txt, ts, nick, isGuest, messageId);
    });
    ...
    (jid, txt, myJid, ts, messageId) => {
        const participantId = Strophe.getResourceFromJid(jid);
        conference.eventEmitter.emit(JitsiConferenceEvents.PRIVATE_MESSAGE_RECEIVED, participantId, txt, ts, messageId);
    });
